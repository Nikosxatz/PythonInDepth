...
class trapoula:
    def __init__(self,x,ar):
        ...
        print('Μόλις δημιούργησα μια {} τράπουλα με {} χαρτιά'.format(x,len(self.kartes)))
                
    def display(self):
        print('Τράπουλα :',self.xroma,'  Χαρτιά :',len(self.kartes))
        print('===================================================')
    ...
    def suffle(self):
        ...
        print('Μόλις ανακάτεψα την {} τράπουλα με {} χαρτιά'.format(self.xroma,len(self)))
...
class mana:
    ...
    def pexe_31(self,p):
        ...
        while True:
            ...
            k=self.dose_karta(p)
            k.display()
            p.moy_dinoyn_karta(k)
            print('Σύνολο πόντων:',p.pontoi())
            while True:
                bet=int(input('{} δώσε το ποντάρισμά σου (1~10 euro) -> '.format(p.onoma)))
                if bet>=1 and bet<=10: break
            print('\nΤώρα τραβάει η μάνα')
            ...
            if self.pontoi()==31:                
                ...
                print('Οπς ... κάϊκα με',self.pontoi(),'πόντους')
                self.exasa(bet)
                p.kerdisa(bet)
            else:
...
class paiktis:
    ...
    def zito_karta(self,m):
        krt=m.dose_karta(self)
        self.kartes.append(krt)
        return krt

    def moy_dinoyn_karta(self,krt):
        self.kartes.append(krt)
